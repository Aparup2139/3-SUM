  ...
  return (
    <SidebarMenu>
      <SidebarMenuItem>
        <SidebarMenuButton
          size="lg"
          className="data-[state=open]:bg-sidebar-accent flex items-center justify-center data-[state=open]:text-sidebar-accent-foreground"
        >
          <div className="text-sidebar-primary-foreground  flex aspect-square size-8 items-center justify-center rounded-lg">
            <svg width="26" height="20" viewBox="0 0 56 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="grid flex-1 text-left text-sm leading-tight mt-3">
            <span className="truncate font-medium">Mid-Events</span>
          </div>
        </SidebarMenuButton>
      </SidebarMenuItem>
    </SidebarMenu>
